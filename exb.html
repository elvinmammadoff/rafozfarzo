                    ...
                    <li class="Menu-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="dropdown-menu__item">
                                <a href="/blog-single.html" title="Blog Single" class="dropdown-menu__link">Blog Single</a>
                            </li>
                        </ul>
                    </li><!-- End /.Menu-item-->
            ...
            <section class="Cover Cover--blog d-flex align-items-center">
                <div class="container">
                    <div class="Cover__content Cover__content--border">
                        <h2 class="Cover__title">Exhibitions</h2>
                    </div>
                </div>
            </section><!-- End /.Cover -->
                        ...
                        <div class="swiper-container">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5">
                                            <img src="src/assets/img/exb/exb-1.jpg" alt="" class="exb-img w-100">
                                            <div class="exb-label">
                                                <span class="exb-circle"></span>
                                                <span class="exb-date">2017</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 text-left exb-content">
                                            <h3 class="exb-ttl">Through the Eyes of Kubrick</h3>
                                            <h4 class="exb-subttl">Individual</h4>
                                            <p class="exb-desc">s a genre of Japanese art that became popular in the 17th century through to the 19th century. 
                                                The word roughly translates as “pictures of the floating world” and artists belonging to the movement 
                                                produced woodblock prints and paintings of scenes from history and folktales, sumo wrestlers, 
                                                landscapes of flora and fauna, and a touch of erotica.
                                            </p>
                                            <a href="#" class="exb-link">Details</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5">
                                            <img src="src/assets/img/exb/exb-2.jpg" alt="" class="exb-img w-100">
                                            <div class="exb-label">
                                                <span class="exb-circle"></span>
                                                <span class="exb-date">2018</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 text-left exb-content">
                                            <h3 class="exb-ttl">Through the Eyes of Kubrick</h3>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5">
                                            <img src="src/assets/img/exb/exb-3.jpg" alt="" class="exb-img w-100">
                                            <div class="exb-label">
                                                <span class="exb-circle"></span>
                                                <span class="exb-date">2019</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 text-left exb-content">
                                            <h3 class="exb-ttl">Through the Eyes of Kubrick</h3>
