                ...
                <div class="container">
                    ...
                    <div class="Contact__form">
                        ...
                        <form action="" method="POST" class="Form d-flex justify-content-between flex-wrap"
                            ...
                            <!-- Start .Form__group -->
                            <div class="Form__group">
                                <input type="email" class="Form__input" id="email" spellcheck="false" autocapitalize="off"
                                    required>
                            ...
                            <!-- Start .Form__group -->
                            <div class="Form__group">
                                <input type="text" class="Form__input" id="subject" spellcheck="false" autocapitalize="off"
                                    required>
                            ...
                            <!-- Start .Form__group -->
                            <div class="Form__group">
                                <textarea rows="5" id="message" class="Form__input Form__input--textarea" spellcheck="false"
