							...
							<div class="row">
								...
								<div class="col-lg-6 order-1 order-lg-2">
									<div class="row g-photo-thumbs">
										...
										<div class="col-lg-12">
											<img src="src/assets/img/portfolio/portfolio-2.jpg" alt="portfolio thumb">
										</div>
										<div class="col-lg-12">
											<img src="src/assets/img/portfolio/portfolio-3.jpg" alt="portfolio thumb">
										</div>
										<div class="col-lg-12">
											<img src="src/assets/img/portfolio/portfolio-4.jpg" alt="portfolio thumb">
										</div>
									</div>
								</div>
							</div>
