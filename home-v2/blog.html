...
<body class="d-flex flex-column justify-content-between">
    ...
    <nav class="cd-nav-container burger-menu burger-menu--right" id="cd-nav">
        ...
        <div class="burger-menu__bottom">
            ...
            <!-- Start .copyright -->
            <p class="copyright">© 2024 Envato. All rights reserved. Theme by Alissio</p><!-- End /.copyright -->
    ...
    <footer class="Footer">
        ...
        <div class="container">
            ...
            <div class="Footer__content">
                ...
                <p class="copyright copyright--white">© 2024 All rights reserved. Theme by Alissio</p>
                <!-- End /.container -->
