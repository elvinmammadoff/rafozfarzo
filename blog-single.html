                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                ...
                                <div class="Form__group">
                                    <input type="text" class="Form__input" id="name" spellcheck="false" autocapitalize="off"
                                        required>
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <!-- Start .Form__group -->
                                <div class="Form__group">
                                    <textarea rows="1" id="message" class="Form__input Form__input--textarea"
                                        spellcheck="false" autocapitalize="off" required></textarea>
