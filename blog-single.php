...
<html lang="en" dir="ltr">
    <head>
        ...
        <!-- Title -->
        <title>Rafoz Farzo - Photography</title>

        <!-- All styles for this template -->
        <link rel="stylesheet" href="src/assets/css/main.min.css">
        <!-- <link href="libs/lightgallery/dist/css/lightgallery.min.css" rel="stylesheet">   -->
...
<nav class="cd-nav-container burger-menu burger-menu--right" id="cd-nav">
    <div class="burger-menu__open">
        <a href="/" class="burger-menu__logo" title="Rafoz Farzo - Photography Template">
            <img src="src/assets/img/Logo.png" alt="Rafoz Farzo - Photography Template" title="Rafoz Farzo - Photography Template" width="199" height="45" />
        </a>
...
<footer class="Footer">
    ...
    <div class="container">
        ...
        <p class="copyright copyright--white">© 2018 Envato. All rights reserved. Theme by Alissio</p>
        <!-- End /.container -->
